...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView detected_language;

   // String[] fromLanguage={"From","English","Africans","Arabic","Belarusian","Bulgarian","Bengali","Catalan","Czech","Belch","Hindi","Urdu"};
    String[] ToLanguage={"To..","Bengali","English","Gujarati","Hindi","Malayalam","Marathi","Myanmar","Nepali","Punjabi","Tamil","Telugu","Urdu"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detected_language=findViewById(R.id.detected_language);
...
//                    Toast.makeText(MainActivity.this, "Please select source language", Toast.LENGTH_SHORT).show();
                    ...
                    PyObject obj2=pyObject.callAttr("mainn",sourcetext.getText().toString());
                    detected_language.setText("From: " +obj2.toString());

                    PyObject obj=pyObject.callAttr("main",sourcetext.getText().toString(),toLanguageCode.toString());
                    Log.d(TAG,obj.toString());
                    translated_text.setText(obj.toString());
        ...
        mic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              // intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, CHINESE);//Locale.getDefault()
    ...
    private String getLanguageCode(String language){
        String languageCode="";
        switch (language){
//            "Bengali","English","Gujarati","Hindi","Malayalam","Marathi","Myanmar","Nepali","Punjabi","Tamil","Telugu","Urdu"
            case "Bengali" : languageCode="bn" ;break;
            case "English" : languageCode= "en";break;
            case "Gujarati" : languageCode= "gu";break;
            case "Hindi" : languageCode= "hi";break;
            case "Malayalam" : languageCode= "ml";break;
            case "Marathi" : languageCode= "mr";break;
            case "Myanmar" : languageCode= "my";break;
            case "Nepali" : languageCode= "ne";break;
            case "Punjabi" : languageCode= "pa";break;
            case "Tamil" : languageCode= "ta";break;
            case "Telugu" : languageCode= "te";break;
            case "Urdu" : languageCode= "ur";break;
